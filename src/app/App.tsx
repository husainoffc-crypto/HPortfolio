...
const projects = [
  ...
  { n: 'Project 06', name: 'Amplify', desc: 'Amplify is a platform designed to enhance digital communication and information management. The project focuses on clean UI patterns and structured navigation, enabling users to interact with platform features efficiently.', tech: 'Figma · Adobe XD · Live', letter: 'A', dark: false, link: 'https://www.figma.com/proto/AskFqU3CzIahQ8VUzpEx7f/The-Academy-group?node-id=4270-4957&viewport=6005%2C-6426%2C0.3&t=Eh0OqRYLFf923rDk-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=4270%3A4957&show-proto-sidebar=1&page-id=1822%3A1446' },
